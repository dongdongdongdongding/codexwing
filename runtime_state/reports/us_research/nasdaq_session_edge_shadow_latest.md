...
- generated_at: `2026-06-29T17:31:45.510920+00:00`
...
- `nasdaq_session_regular_close_strength_liq_trend_top1_v1` `regular_close_strength_liq_trend` / `score_liquid_open_drive` top1 recent_shadow `True` production `False` ret5 `9.359025` win `0.68` net `5.711348` touch `0.72` ft `0.74` dd `0.34`
