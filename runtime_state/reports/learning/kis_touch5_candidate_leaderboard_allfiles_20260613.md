...
- generated_at: `2026-06-13T13:04:23+00:00`
- dummy_data_used: `False`
- tracked_sources_only: `False`
- report_count: `49`
- unique_candidates: `5690`
...
- candidates/shadow/sample_only/production: `2882` / `393` / `252` / `0`
...
## KOSDAQ
- status: `shadow_candidates_found_no_upgrade`
- candidates/shadow/sample_only/production: `2808` / `250` / `82` / `0`
