...
- generated_at: `2026-06-12T20:46:26+00:00`
- dummy_data_used: `False`
- tracked_sources_only: `True`
- report_count: `31`
- unique_candidates: `2972`
...
- candidates/shadow/sample_only/production: `1601` / `847` / `200` / `0`
...
## KOSDAQ
- status: `shadow_candidates_found_no_upgrade`
- candidates/shadow/sample_only/production: `1371` / `637` / `214` / `0`
