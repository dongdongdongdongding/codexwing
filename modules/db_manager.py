        ...
        for row in outcomes:
            ...
            rows.append(
                self._filter_payload_to_existing_columns("agent_realized_outcomes", {
                    ...
                    "ordered_entry_at": row.get("ordered_entry_at"),
                    "ordered_entry_price": row.get("ordered_entry_price"),
                    "ordered_target_hit_at": row.get("ordered_target_hit_at"),
                    "ordered_stop_hit_at": row.get("ordered_stop_hit_at"),
                    "ordered_mfe_until_terminal_5d_pct": row.get("ordered_mfe_until_terminal_5d_pct"),
                    "ordered_mae_until_terminal_5d_pct": row.get("ordered_mae_until_terminal_5d_pct"),
                    "ordered_mae_before_target_5d_pct": row.get("ordered_mae_before_target_5d_pct"),
                    "outcome_path_bar_count": row.get("outcome_path_bar_count"),
                    "outcome_path_source": row.get("outcome_path_source"),
                    "outcome_path_warnings": row.get("outcome_path_warnings"),
                    ...
                    "theme_routing_path": row.get("theme_routing_path"),
                    "theme_score_adjustment": row.get("theme_score_adjustment"),
                    "theme_day_symbol_count": row.get("theme_day_symbol_count"),
                    "theme_day_avg_alpha_score": row.get("theme_day_avg_alpha_score"),
                    "theme_day_avg_decision_score": row.get("theme_day_avg_decision_score"),
                    "theme_day_avg_volume_ratio": row.get("theme_day_avg_volume_ratio"),
                    "theme_day_avg_day_return_pct": row.get("theme_day_avg_day_return_pct"),
                    "theme_day_positive_return_pct": row.get("theme_day_positive_return_pct"),
                    "theme_day_strength_rank": row.get("theme_day_strength_rank"),
                    "theme_day_strength_bucket": row.get("theme_day_strength_bucket"),
                    "regime_breadth_pct": row.get("regime_breadth_pct"),
                    "regime_avg_chg": row.get("regime_avg_chg"),
                    "regime_volatility_20d": row.get("regime_volatility_20d"),
                    "kospi_chg": row.get("kospi_chg"),
                    "kosdaq_chg": row.get("kosdaq_chg"),
                    ...
                    "entry_readiness_contract": row.get("entry_readiness_contract"),
                    "stock_quality_score": row.get("stock_quality_score"),
                    "stock_quality_grade": row.get("stock_quality_grade"),
                    "upside_room_score": row.get("upside_room_score"),
                    "upside_room_grade": row.get("upside_room_grade"),
                    "entry_timing_score": row.get("entry_timing_score"),
                    "entry_timing_grade": row.get("entry_timing_grade"),
                    "chase_risk_level": row.get("chase_risk_level"),
                    "chase_risk_reasons": row.get("chase_risk_reasons"),
                    "exclusion_risk_level": row.get("exclusion_risk_level"),
                    "final_action": row.get("final_action"),
                    "action_reason_codes": row.get("action_reason_codes"),
    ...
    def save_post_scan_outcome_ledger(self, run_id, rows):
        ...
        for row in rows:
            ...
            payload = {
                ...
                "regime_theme_adjustment": row.get("regime_theme_adjustment"),
                "candidate_data_quality": row.get("candidate_data_quality"),
                "data_required_present_pct": row.get("data_required_present_pct"),
                "data_warning_level": row.get("data_warning_level"),
                "entry_readiness_contract": row.get("entry_readiness_contract"),
                "stock_quality_score": row.get("stock_quality_score"),
                "stock_quality_grade": row.get("stock_quality_grade"),
                "upside_room_score": row.get("upside_room_score"),
