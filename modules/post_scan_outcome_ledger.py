...
def _load_top_deep_section_map(run_id: str, report_dir: Optional[Path] = None) -> Dict[str, Dict[str, Any]]:
    ...
    for item in reports:
        ...
        out[ticker] = {
            ...
            "chase_risk_reasons": item.get("chase_risk_reasons") or readiness_contract.get("chase_risk_reasons"),
    ...
    *,
    ...
    for idx, outcome in enumerate(outcomes or [], start=1):
        ...
        row = {
            ...
            "chase_risk_reasons": _first_present(outcome.get("chase_risk_reasons"), section_meta.get("chase_risk_reasons"), readiness_contract.get("chase_risk_reasons")),
            ...
            "ordered_entry_at": outcome.get("ordered_entry_at"),
            "ordered_entry_price": _safe_float(outcome.get("ordered_entry_price")),
            "ordered_target_hit_at": outcome.get("ordered_target_hit_at"),
            "ordered_stop_hit_at": outcome.get("ordered_stop_hit_at"),
            "ordered_mfe_until_terminal_5d_pct": _safe_float(outcome.get("ordered_mfe_until_terminal_5d_pct")),
            "ordered_mae_until_terminal_5d_pct": _safe_float(outcome.get("ordered_mae_until_terminal_5d_pct")),
            "ordered_mae_before_target_5d_pct": _safe_float(outcome.get("ordered_mae_before_target_5d_pct")),
            "outcome_path_bar_count": outcome.get("outcome_path_bar_count"),
            "outcome_path_source": outcome.get("outcome_path_source"),
            "outcome_path_warnings": outcome.get("outcome_path_warnings"),
