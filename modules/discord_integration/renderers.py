...
_SIGNALS_VIEW = {
    "": {
        "title": "🎯 모델 시그널 (라이브 레인)",
        "description": (
            "🟢장중(rank-1 선별, §7-E 승격): 코스피 +5% 터치익절/5일 · 코스닥 15:00 VWAP가드 +10% 터치익절/5일 | "
    ...
    "INTRADAY": {
        ...
        "description": "rank-1 고확신 선별(§7-E) · 코스피 +5% 터치익절/5일 · 코스닥 15:00 VWAP가드 +10% 터치익절/5일 · 터치시 익절, 아니면 종가 청산 · 분산(타이트 손절 X)",
        "color": 0x2ECC71,
        "empty": "표시할 인트라데이 모델 픽이 없습니다.",
    },
    "SWING": {
        "title": "🔵 스윙 시그널 (스윙 모델 레인)",
        "description": "8y first-touch 랭커(P3 교체, 익일시가 진입·+5% 터치익절/5일) + 나스닥 세션 · 분산(타이트 손절 X)",
        "color": 0x3498DB,
