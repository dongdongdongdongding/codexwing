...
SCAN_RESULT_COLUMNS: tuple = (
    ...
    ("foreigner_1d",                    "foreigner_1d",                    _to_float_or_none),
    ("institution_1d",                  "institution_1d",                  _to_float_or_none),
    ("retail_1d",                       "retail_1d",                       _to_float_or_none),
    ("foreigner_3d",                    "foreigner_3d",                    _to_float_or_none),
    ("institution_3d",                  "institution_3d",                  _to_float_or_none),
    ("retail_3d",                       "retail_3d",                       _to_float_or_none),
    ("foreigner_10d",                   "foreigner_10d",                   _to_float_or_none),
    ("institution_10d",                 "institution_10d",                 _to_float_or_none),
    ("retail_10d",                      "retail_10d",                      _to_float_or_none),
    ("whale_flow_1d",                   "whale_flow_1d",                   _to_float_or_none),
    ("whale_flow_3d",                   "whale_flow_3d",                   _to_float_or_none),
    ("whale_flow_10d",                  "whale_flow_10d",                  _to_float_or_none),
    ("flow_window",                     "flow_window",                     _passthrough),
    ("flow_asof",                       "flow_asof",                       _passthrough),
    ...
    ("ordered_entry_at",                "ordered_entry_at",                _passthrough),
    ("ordered_entry_price",             "ordered_entry_price",             _to_float_or_none),
    ("ordered_target_hit_at",           "ordered_target_hit_at",           _passthrough),
    ("ordered_stop_hit_at",             "ordered_stop_hit_at",             _passthrough),
    ("ordered_mfe_until_terminal_5d_pct", "ordered_mfe_until_terminal_5d_pct", _to_float_or_none),
    ("ordered_mae_until_terminal_5d_pct", "ordered_mae_until_terminal_5d_pct", _to_float_or_none),
    ("ordered_mae_before_target_5d_pct", "ordered_mae_before_target_5d_pct", _to_float_or_none),
    ("outcome_path_bar_count",          "outcome_path_bar_count",          _to_int_or_none),
    ("outcome_path_source",             "outcome_path_source",             _passthrough),
    ("outcome_path_warnings",           "outcome_path_warnings",           _passthrough),
