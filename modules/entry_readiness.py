...
def _build_upside_score(price: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "chase_risk_reasons": [str(row.get("code")) for row in triggered if row.get("code")],
        "filters": filters,
        "evidence": evidence[:6],
        "warnings": warnings,
    }
...
def build_entry_readiness_analysis(
    *,
    ...
    analysis = {
        ...
        "chase_risk_reasons": upside.get("chase_risk_reasons") or [],
    ...
    analysis.update(
        {
            ...
            "chase_risk_reasons": contract.get("chase_risk_reasons"),
