...
POST_SCAN_VALIDATION_COMMANDS = (
    ...
    {
        "name": "Exact Path Feature Watch",
        "command": [
            sys.executable,
            "multi_agent/tools/mine_significant_feature_combinations.py",
            "--stem",
        ...
        "md_path": "runtime_state/reports/experimental/significant_feature_combinations_exact_path_top5_exception_latest.md",
        "json_path": "runtime_state/reports/experimental/significant_feature_combinations_exact_path_top5_exception_latest.json",
    },
    {
        "name": "Exact Path Feature Watch Strict",
        "command": [
            sys.executable,
            "multi_agent/tools/mine_significant_feature_combinations.py",
            "--stem",
            "significant_feature_combinations_exact_path_top5_exception_strict_latest",
            "--markets",
            "KOSPI,KOSDAQ",
            "--scopes",
            "top5_exception",
        ...
        "md_path": "runtime_state/reports/experimental/significant_feature_combinations_exact_path_top5_exception_strict_latest.md",
    ...
    {
        "name": "INTRADAY Loss Guard Watch",
        "command": [
            sys.executable,
            "multi_agent/tools/mine_loss_exclusion_guards.py",
            "--scan-mode",
            "INTRADAY",
            "--stem",
            "intraday_loss_exclusion_guard_watch_latest",
            "--markets",
            "KOSPI,KOSDAQ",
            "--scopes",
            "top5,exception_leader,top5_exception,ranked_top20",
            "--horizons",
            "1d,3d,5d",
            "--beam-width",
            "16",
        ...
        "md_path": "runtime_state/reports/experimental/intraday_loss_exclusion_guard_watch_latest.md",
        "json_path": "runtime_state/reports/experimental/intraday_loss_exclusion_guard_watch_latest.json",
    },
)
