        ...
        rows.append(
            {
                ...
                "final_action": getattr(dec, "final_action", "") or None,
                "entry_condition_text": getattr(dec, "entry_condition_text", "") or None,
                "stop_condition_text": getattr(dec, "stop_condition_text", "") or None,
                "structured_conditions": dict(getattr(dec, "structured_conditions", {}) or {}),
                "target_tp_pct": (getattr(dec, "structured_conditions", {}) or {}).get("target_tp_pct"),
                "stop_sl_pct": (getattr(dec, "structured_conditions", {}) or {}).get("stop_sl_pct"),
                "hold_days": (getattr(dec, "structured_conditions", {}) or {}).get("hold_days"),
                "entry_policy": (getattr(dec, "structured_conditions", {}) or {}).get("entry_policy"),
                ...
                "theme_score_adjustment": getattr(dec, "theme_score_adjustment", None),
                "theme_day_symbol_count": getattr(dec, "theme_day_symbol_count", None) or getattr(dec, "_theme_day_symbol_count", None),
                "theme_day_avg_alpha_score": getattr(dec, "theme_day_avg_alpha_score", None) or getattr(dec, "_theme_day_avg_alpha_score", None),
                "theme_day_avg_decision_score": getattr(dec, "theme_day_avg_decision_score", None) or getattr(dec, "_theme_day_avg_decision_score", None),
                "theme_day_avg_volume_ratio": getattr(dec, "theme_day_avg_volume_ratio", None) or getattr(dec, "_theme_day_avg_volume_ratio", None),
                "theme_day_avg_day_return_pct": getattr(dec, "theme_day_avg_day_return_pct", None) or getattr(dec, "_theme_day_avg_day_return_pct", None),
                "theme_day_positive_return_pct": getattr(dec, "theme_day_positive_return_pct", None) or getattr(dec, "_theme_day_positive_return_pct", None),
                "theme_day_strength_rank": getattr(dec, "theme_day_strength_rank", None) or getattr(dec, "_theme_day_strength_rank", None),
                "theme_day_strength_bucket": getattr(dec, "theme_day_strength_bucket", "") or getattr(dec, "_theme_day_strength_bucket", "") or None,
                "regime_breadth_pct": getattr(dec, "regime_breadth_pct", None),
                "regime_avg_chg": getattr(dec, "regime_avg_chg", None),
                "regime_volatility_20d": getattr(dec, "regime_volatility_20d", None),
                "kospi_chg": getattr(dec, "kospi_chg", None),
                "kosdaq_chg": getattr(dec, "kosdaq_chg", None),
        ...
        rows.append(
            {
                ...
                "stop_condition_text": meta.get("stop_condition_text"),
                "structured_conditions": meta.get("structured_conditions"),
                ...
                "theme_score_adjustment": meta.get("theme_score_adjustment"),
                "theme_day_symbol_count": meta.get("theme_day_symbol_count") or meta.get("_theme_day_symbol_count"),
                "theme_day_avg_alpha_score": meta.get("theme_day_avg_alpha_score") or meta.get("_theme_day_avg_alpha_score"),
                "theme_day_avg_decision_score": meta.get("theme_day_avg_decision_score") or meta.get("_theme_day_avg_decision_score"),
                "theme_day_avg_volume_ratio": meta.get("theme_day_avg_volume_ratio") or meta.get("_theme_day_avg_volume_ratio"),
                "theme_day_avg_day_return_pct": meta.get("theme_day_avg_day_return_pct") or meta.get("_theme_day_avg_day_return_pct"),
                "theme_day_positive_return_pct": meta.get("theme_day_positive_return_pct") or meta.get("_theme_day_positive_return_pct"),
                "theme_day_strength_rank": meta.get("theme_day_strength_rank") or meta.get("_theme_day_strength_rank"),
                "theme_day_strength_bucket": meta.get("theme_day_strength_bucket") or meta.get("_theme_day_strength_bucket"),
                "regime_breadth_pct": meta.get("regime_breadth_pct"),
                "regime_avg_chg": meta.get("regime_avg_chg"),
                "regime_volatility_20d": meta.get("regime_volatility_20d"),
                "kospi_chg": meta.get("kospi_chg"),
                "kosdaq_chg": meta.get("kosdaq_chg"),
                "entry_reference_price": _resolve_reference_price(
                    ticker,
        ...
        meta.append(
            {
                ...
                "model_prob_available_count": extra.get("model_prob_available_count"),
                "model_prob_mean": extra.get("model_prob_mean"),
                "low_model_prob_score": extra.get("low_model_prob_score"),
                "low_prob_high_score": extra.get("low_prob_high_score"),
                "expected_edge_inversion_score": extra.get("expected_edge_inversion_score"),
                "loss_risk_score": extra.get("loss_risk_score"),
                "relative_rank_score": extra.get("relative_rank_score"),
                "relative_rank_pct": extra.get("relative_rank_pct"),
                "regime_adjusted_grade": extra.get("regime_adjusted_grade"),
                "relative_rank_model": extra.get("relative_rank_model"),
                ...
                "theme_risk": extra.get("theme_risk") or [],
                "rationale": extra.get("rationale") or [],
                "final_action": extra.get("final_action") or "관망",
                "entry_condition_text": extra.get("entry_condition_text")
                or "시장 정책이 관망 구간입니다. GREEN/YELLOW 회복 후 재평가",
                "stop_condition_text": extra.get("stop_condition_text")
                or "진입 전 상태이므로 손절가 대신 제외 조건으로 관리",
                "structured_conditions": extra.get("structured_conditions") or {},
                "target_tp_pct": extra.get("target_tp_pct"),
                "stop_sl_pct": extra.get("stop_sl_pct"),
                "hold_days": extra.get("hold_days"),
                "entry_policy": extra.get("entry_policy"),
            }
        )
    return meta
    ...
    *,
    ...
    decision_details = {
        str(getattr(dec, "ticker", "") or ""): {
            ...
            "relative_rank_score": getattr(dec, "relative_rank_score", None),
            "relative_rank_pct": getattr(dec, "relative_rank_pct", None),
            "regime_adjusted_grade": getattr(dec, "regime_adjusted_grade", ""),
            "relative_rank_model": getattr(dec, "relative_rank_model", ""),
            ...
            "theme_risk": list(getattr(dec, "theme_risk", []) or []),
            "rationale": list(getattr(dec, "rationale", []) or []),
            "final_action": "관망",
