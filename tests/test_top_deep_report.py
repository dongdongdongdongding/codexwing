...
def test_build_top_deep_reports_merges_real_scan_and_planner_trace():
    ...
    assert report["realized_expectancy_admission"]["policy_version"] == "scan_universe_admission_runtime_v2_entry_touch"
    ...
    assert isinstance(report["entry_readiness_contract"]["chase_risk_reasons"], list)
    assert report["chase_risk_reasons"] == report["entry_readiness_contract"]["chase_risk_reasons"]
